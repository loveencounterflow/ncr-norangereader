(function() {
  "use strict";
  var CLOAK, CND, DIFF, alert, badge, cloak, cloaked_text, debug, echo, esc_re, help, info, isa, log, rainbow, rpr, text, type_of, types, uncloaked_text, urge, validate, warn, whisper;
